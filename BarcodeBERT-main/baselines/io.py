...
from baselines.embedders import (
    ...
    ConvNovaEmbedder,
    ConvNovaLongEmbedder,
    JanusConvNovaEmbedder,
)
...
def load_baseline_model(backbone_name, *args, **kwargs):
    ...
    backbones = {
        ...
        "ConvNova": ConvNovaEmbedder,
        "ConvNovaLong": ConvNovaLongEmbedder,
        "JanusConvNova": JanusConvNovaEmbedder,
    }
